  ...
  return (
    <div className="flex justify-center items-center h-full">
      <div className="px-12 py-12 bg-white rounded-3xl flex flex-col">
        <div>
          <h1 className=" text-rose-600 text-center text-4xl mt-4">
            Prometo Food
          </h1>
        ...
        <div className="flex flex-col">
          <p>Username</p>
          <input
            className=" rounded-lg text-xs w-full my-2"
          ...
          <p>Password</p>
          <input
            className=" rounded-lg text-xs w-full mt-2"
            placeholder="Enter a password"
            type="password"
            onChange={(e) => setPassword(e.target.value)}
          />
          <a
            className="hover:cursor-pointer w-full text-right underline text-xs text-blue-600 mt-1"
        ...
        <div>
          <Button
            className="w-full bg-btn font-light my-4"
